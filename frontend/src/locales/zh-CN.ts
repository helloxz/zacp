...
export default {
  ...
  settings: {
    ...
    agent: {
      ...
      discard: '放弃修改',
      channelSetting: '默认渠道设置',
      zliteChannelTitle: '默认渠道设置',
      zliteTypeLabel: '渠道类型',
      zliteBaseUrlLabel: '自定义 BaseURL',
      zliteBaseUrlRequired: '请输入 BaseURL',
      zliteBaseUrlInvalid: 'BaseURL 需以 http:// 或 https:// 开头',
      zliteApiKeyLabel: 'API 密钥',
      zliteApiKeyPlaceholder: '输入 API 密钥（可为空）',
      zliteModelsLabel: '可用模型',
      zliteModelsHint: '回车添加多个模型，点击 × 删除',
      zliteModelsRequired: '请至少添加一个可用模型',
      zliteLoadFailed: '加载默认渠道设置失败',
      zliteSaveSuccess: '已保存',
      zliteSaveFailed: '保存失败，请重试',
      zliteFetchModels: '获取模型',
      zliteTestModel: '测试',
      zliteClear: '清空',
      zliteFetchSuccess: '已获取 {count} 个模型',
      zliteFetchFailed: '获取模型失败',
      zliteTestSuccess: '模型 {model} 测试通过',
      zliteTestFailed: '模型测试失败',
      zliteTestNoModel: '请先添加模型',
      zliteAvailableModels: '可用模型 ({count})',
      zlitePickModel: '选择一个模型填充',
      zliteFillAll: '全部填充',
      zliteFillAllSuccess: '已填充 {count} 个新模型',
      zliteFillAllNoNew: '没有可新增的模型',
      zliteFillOneSuccess: '已添加 {model}',
      zliteModelExists: '该模型已存在',
      install: '安装 Zlite',
  ...
  login: {
    ...
    captchaInvalid: '验证码错误或已过期，请重试',
    captchaRefresh: '点击刷新验证码',
    submit: '登录',
    success: '登录成功',
    failed: '用户名或密码错误',
    ipBlocked: 'IP已被拉黑，请重启服务解除限制',
